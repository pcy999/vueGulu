...
!function (t) {
  ...
  e = function e() {
    var t, e, c, l;
    (l = document.createElement("div")).innerHTML = i, i = null, (c = l.getElementsByTagName("svg")[0]) && (c.setAttribute("aria-hidden", "true"), c.style.position = "absolute", c.style.width = 0, c.style.height = 0, c.style.overflow = "hidden", t = c, (e = document.body).firstChild ? (l = t, (c = e.firstChild).parentNode.insertBefore(l, c)) : e.appendChild(t));
  ...
  }, document.addEventListener("DOMContentLoaded", _c, !1)) : document.attachEvent && (l = e, o = t.document, a = !1, (_n = function n() {
    try {
...

{
  ...
  (0, _chai.expect)(href).to.eq("#isetting");
  button.$el.remove();
  button.$destroy();
}
{
  ...
  (0, _chai.expect)(_href).to.eq("#iloading");
